...
function MainApp() {
  ...
  return (
    <div
      className={`w-full min-h-screen flex flex-col font-sans transition-colors duration-300 ${
        theme === "dark"
          ...
          >
            <Routes location={location}>
              <Route
                path="/"
                element={
                  <HeroSlide onOpenResume={handleDownloadCV} theme={theme} />
                }
              />
              ...
              <Route
                path="/resume/:id"
                element={<ExperienceDetailSlide theme={theme} />}
              />
              <Route
                path="/projects"
                element={<ProjectsSlide theme={theme} />}
              />
              <Route
                path="/projects/:id"
                element={<ProjectDetailSlide theme={theme} />}
              />
