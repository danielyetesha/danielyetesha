...
export const AboutSlide: React.FC<AboutSlideProps> = ({ theme }) => {
  ...
  return (
    <div
      className={`relative w-full min-h-[calc(100vh-5rem)] flex flex-col transition-colors duration-300 ${
        theme === "dark"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 py-8 sm:py-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start lg:pointer-events-none">
        ...
        >
          ...
          <img
            ...
            style={{
              clipPath: hoverPos
                ? `circle(100px at ${hoverPos.x}px ${hoverPos.y}px)`
                : "circle(0px at 0 0)",
          ...
          <div className="absolute bottom-4 left-4 right-4 text-center text-white">
            ...
            <p className="text-xs font-mono text-neutral-300">
              Data Analyst & Scientist • Bank of Abyssinia
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="space-y-3">
            <div className="inline-block relative">
              ...
              <div
                className={`h-1.5 w-24 mt-2 rounded-full mx-auto lg:mx-0 ${
            ...
            {/* Email Subtitle */}
            <div
              className={`pt-2 font-mono text-sm sm:text-base font-semibold ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-xl mx-auto lg:mx-0 pt-2">
            ...
            >
              ...
              <div
                className={`text-xs font-mono pt-0.5 ${theme === "dark" ? "text-neutral-300" : "text-slate-600"}`}
              >
                Bank of Abyssinia
              </div>
            </div>
          ...
          <div
            className={`pt-6 border-t flex flex-wrap items-center justify-between text-xs font-mono max-w-xl mx-auto lg:mx-0 ${
              theme === "dark"
