...
import { Mail, Phone, Linkedin, Github, MessageCircle, ExternalLink } from 'lucide-react';
...
export const ContactSlide: React.FC<ContactSlideProps> = ({ theme }) => {
  ...
  return (
    <div className={`w-full min-h-[calc(100vh-5rem)] flex items-center justify-center px-6 sm:px-12 lg:px-20 py-4 sm:py-6 transition-colors duration-300 overflow-y-auto lg:overflow-hidden ${
      ...
      <div className="max-w-5xl w-full space-y-6 my-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-2">
              <div className="inline-block relative">
                ...
                <div className={`h-1.5 w-16 mt-1.5 rounded-full mx-auto lg:mx-0 ${
                  theme === 'dark' ? 'bg-white' : 'bg-slate-900'
                }`} />
              </div>

              <div className={`font-mono text-xs sm:text-sm pt-1 ${
            ...
            {/* Intro Paragraph */}
            <p className={`text-sm sm:text-base font-light leading-relaxed max-w-lg mx-auto lg:mx-0 ${
              theme === 'dark' ? 'text-neutral-300' : 'text-slate-700'
            }`}>
              Feel free to reach out for business intelligence consultation, data science collaboration, automated financial reporting pipelines, or general inquiries.
            </p>
            ...
            <div className="space-y-4 pt-2 max-w-md mx-auto lg:mx-0 font-mono">
              <div className="space-y-0.5">
                ...
                <div className={`text-[11px] ${theme === 'dark' ? 'text-neutral-500' : 'text-slate-500'}`}>
          ...
          >
            <div className={`p-6 sm:p-7 rounded-3xl space-y-4 shadow-sm transition-all ${
              theme === 'dark'
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className={`p-2 rounded-xl ${
                          theme === 'dark' ? 'bg-neutral-800 text-white' : 'bg-slate-200 text-slate-900'
                        }`}>
              ...
              <div className={`pt-1 text-center text-[11px] font-mono ${
                theme === 'dark' ? 'text-neutral-500' : 'text-slate-400'
              }`}>
                Available for remote & hybrid opportunities in Ethiopia & globally
              </div>
            </div>
          </motion.div>
