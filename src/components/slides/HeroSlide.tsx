...
export const HeroSlide: React.FC<HeroSlideProps> = ({ onOpenResume, theme }) => {
  return (
    <div className={`relative w-full min-h-[calc(100vh-5rem)] flex flex-col justify-between px-6 sm:px-12 lg:px-16 py-6 overflow-hidden select-none transition-colors duration-300 ${
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto my-auto py-4 flex flex-col lg:grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        >
          <div className="relative w-full max-w-xs aspect-[4/3] rounded-3xl overflow-hidden shadow-md">
            <img
        ...
        >
          {/* Greeting Pill */}
          <div className={`inline-block px-4 py-1.5 rounded-full text-xs font-mono font-bold uppercase tracking-widest ${
            theme === 'dark'
          ...
          <div className="space-y-2">
            ...
            <h2 className={`text-base sm:text-2xl font-bold tracking-wide uppercase font-mono ${
          ...
          {/* Simple Tagline */}
          <p className={`text-sm sm:text-lg max-w-xl font-light leading-relaxed mx-auto lg:mx-0 ${
          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-2">
            <Link
              to="/resume"
              className={`px-6 py-3 rounded-xl text-xs font-bold tracking-widest uppercase transition-all duration-200 shadow-sm ${
                theme === 'dark'
        ...
        >
          <div className="relative w-full max-w-sm aspect-[3/4] rounded-3xl overflow-hidden shadow-md">
            <img
              src={danielPortraitBg}
              alt="Daniel Yetesha"
              className="w-full h-full object-cover object-top filter brightness-95"
            />
            <div className={`absolute bottom-4 left-4 right-4 p-4 rounded-2xl space-y-0.5 ${
              theme === 'dark'
      ...
      <motion.div
        ...
        className={`relative z-10 flex flex-wrap items-center justify-between gap-4 pt-4 border-t text-xs font-mono ${
          theme === 'dark'
